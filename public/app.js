...
async function submitMessage() {
  ...
  try {
    ...
    if (error.name === "AbortError") {
      ...
      addErrorMessage("Supabase rejected the request. Disable JWT verification for this Edge Function or add the Supabase anon key.");
    } else {
      addErrorMessage("The analysis engine could not respond. Please check the Supabase function and secrets.");
    }
