...
async function submitMessage() {
  ...
  try {
    ...
    if (error.name === "AbortError") {
      ...
      addErrorMessage(
        "Supabase rejected the request. Disable JWT verification for this Edge Function."
      );
    } else {
      addErrorMessage(
        "The analysis engine could not respond. Please check the Supabase function and secrets."
      );
    }
  ...
  messages.innerHTML = `
    <article class="message assistant-message">
      ...
      <div class="message-bubble">
        <span class="message-speaker">BONDSTATS AI</span>
        <p>
          New session ready. Ask a question about finance,
          markets, bonds, inflation, central banks or risk.
        </p>
      </div>
    </article>
  `;
